		...
		<div className="grow">
			...
			{component === "input" && (
				<input
					...
					id={id}
					name={name}
					className="m-[5px] border border-lightgrey w-full px-5 py-2"
			...
			{component === "select" && (
				<select
					id={id}
					name={name}
					className="m-[5px] border border-lightgrey w-full px-5 py-2 appearance-none"
					defaultValue=""
					onChange={handleChange}
					required={required}
				>
			...
			{component === "textarea" && (
				<textarea
					...
					name={name}
					rows={rows}
					className="m-[5px] border boder-lightgrey w-full px-5 py-3"
					placeholder={placeholder}
					defaultValue={defaultValue}
					disabled={disabled}
					onChange={handleChange}
